...
import { exchangeGoogleCal, getGoogleCalAddress, calendarRedirectUri } from '@/lib/calendar';
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error('[calendar/callback] token exchange failed:', e instanceof Error ? e.message : e);
