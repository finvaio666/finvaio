...
const navItems = [
  {
    ...
    items: [
      ...
      // Same assistant as the floating launcher and the mobile Chat tab — one
      // name everywhere, and in Workspace rather than buried under Tools.
      { id: 'ai',        label: 'Ask FINVA',  href: '/ai',        feature: undefined, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg> },
    ],
  },
  {
    group: 'Tools',
