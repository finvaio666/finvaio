# Connecting Your Email & Calendar to FINVA

This lets FINVA monitor your institution emails (insurers/fund houses) and show
...
## PART B — Each FA does this in FINVA

### Connect your email (Gmail or Outlook)
1. Log in to FINVA → **Settings** (gear icon) → **Email Hub** tab.
...
| Problem | Fix |
|---------|-----|
| "Google hasn't verified this app" warning | Normal — click **Advanced → Go to FINVA → Allow**. |
